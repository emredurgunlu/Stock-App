...
const stockSlice = createSlice({
  ...
  reducers: {
    ...
    //   state[payload.url] = payload.apiData ------payload.url gelen parametreye göre firms veya sales oluyor. 3 çeşit şekilde aynı işlevi gören getStockSuccess yazdık.
    //   state.loading = false
    // },
    ...
    // promise all için. bak Purchases.jsx ve useStockCalls.jsx
